...
static void SSI1Handler(void);
static void TIMER2Handler(void);
static void GPIOA_ISR(void);
...
NmiSR(void)
{
    ...
    //
    while(1)						// make this a "while(0)" if you want to step back to where the fault ocurred
    {
    }
}
...
SSI1Handler(void)
{
	...
	SSI1_ISR();					// process SSI1 interrupt
	return;
}
...
TIMER2Handler(void)
{
	Timer2_ISR();					// process timer2 interrupt
}

//*****************************************************************************
//
// This is the code that gets called when the processor receives a GPIOA intr.
//
//*****************************************************************************
static void
GPIOA_ISR(void)
